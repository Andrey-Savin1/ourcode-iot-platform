...
import static ru.savin.eventscollectorservice.util.TestContainersConfig.kafkaTest;
...
public class KafkaTestUtils {
    ...
    public static KafkaProducer<String, DeviceEvent> createProducer() {
    ...
    public static KafkaConsumer<String, DeviceEvent> createConsumer(String topic) {
        ...
        KafkaConsumer<String, DeviceEvent> consumer = new KafkaConsumer<>(consumerProps);
